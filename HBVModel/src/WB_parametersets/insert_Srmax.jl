...
"""
OLD: & FALSE This function creates new parameter sets from the older ones. It takes minima and maxima, multiplies it with the % the HRU covers (to account for total storage no Max/avg storage)

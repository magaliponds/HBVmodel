...
@everywhere function run_MC(ID, nmax)
        ...
        for n in 1 : 1:nmax#size(parameters_best_calibrations)[1]
                ...
                if Goodness_Fit != -9999
                        ...
                        if size(All_Goodness)[2]-1 == 100
                                ...
                                if count != 100
                                        open(local_path*"Calibrations/Defreggental/Defreggental_Parameterfit_less_dates_snow_redistr_test"*string(ID)*"_"*string(number_Files)*".csv", "a") do io
        ...
        open(local_path*"Calibrations/Defreggental/Defreggental_Parameterfit_less_dates_snow_redistr_test"*string(ID)*".csv", "a") do io
                writedlm(io, All_Goodness,",")

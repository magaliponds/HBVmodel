...
function budyko_plot_projections_old(rcp, modelpath, startyear_proj, endyear_proj)#All_Catchment_Names, Area_Catchments)
...
print(budyko_plot_projections_old("rcp45","CNRM-CERFACS-CNRM-CM5_rcp45_r1i1p1_CLMcom-CCLM4-8-17_v1_day", 2071,2100))

...
function run_srdef_defreggental( path_to_projection, path_to_best_parameter, startyear, endyear, period, spinup, ploton)
        ...
        for (e, ep_method) in enumerate(EP)
                ...
                for n = 1:1:2#size(parameters_best_calibrations)[1]
                        ...
                        if ploton=="yes"
                                ...
                                yaxis!("mm")
                                #display(Peplot)
                                Plots.savefig( "/Users/magali/Documents/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/Results/Rootzone/"*string(startyear)*"/Defreggental/"*ep_method*"_Pe_melt_timeseries_analysis"*string(startyear)*"_"*string(endyear)*".png" )
                                ...
                                yaxis!("mm")
                                #display(Pepplot)
                                Plots.savefig( "/Users/magali/Documents/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/Results/Rootzone/"*string(startyear)*"/Defreggental/"*ep_method*"_Pep_timeseries_analysis_"*string(startyear)*"_"*string(endyear)*".png" )
                        end
                        ...
                        path_to_folder = "/Users/magali/Documents/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/Results/Rootzone/"*string(startyear)*"/Defreggental/"
                        ...
                        if ploton =="yes"
                                ...
                                yaxis!("mm")
                                xaxis!("Year")
                                Plots.savefig( "/Users/magali/Documents/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/Results/Rootzone/"*string(startyear)*"/Defreggental/"*ep_method*"_srdef_max_year_"*string(startyear)*"_"*string(endyear)*".png", )
                                ...
                                yaxis!("mm")
                                xaxis!("Date")
                                Plots.savefig( "/Users/magali/Documents/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/Results/Rootzone/"*string(startyear)*"/Defreggental/"*ep_method*"_srdef_timeseries_normal_" *string(startyear)*"_"*string(endyear)* "_"*string(n) * ".png", )

                                Plots.plot()
                                plot!( Timeseries[startplot:endplot], srdef_timeseries[startplot:endplot], label = "Sr_def_series", )
                                yaxis!("mm")
                                xaxis!("Date")
                                Plots.savefig( "/Users/magali/Documents/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/Results/Rootzone/"*string(startyear)*"/Defreggental/"*ep_method*"_srdef_timeseries_zoom_" *string(startyear)*"_"*string(endyear)* "_"*string(n) * ".png", )

                                Plots.plot()
                                plot!( Timeseries[index_spinup:end], srdef_continuous, label = "Sr_def", )
                                yaxis!("mm")
                                xaxis!("Date")
                                Plots.savefig( "/Users/magali/Documents/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/Results/Rootzone/"*string(startyear)*"/Defreggental/"*ep_method*"_srdef_timeseries_cum_" *string(startyear)*"_"*string(endyear)* "_"*string(n) * ".png", )

                                Plots.plot()
                                plot!( Timeseries[startplot:endplot], srdef_continuous[startplot+1:endplot+1], label = "Sr_def", )
                                yaxis!("mm")
                                xaxis!("Date")
                                Plots.savefig( "/Users/magali/Documents/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/Results/Rootzone/"*string(startyear)*"/Defreggental/"*ep_method*"_srdef_timeseries_cum_zoom_" *string(startyear)*"_"*string(endyear)* "_"*string(n) * ".png", )
                                ...
                                yaxis!("mm")
                                xaxis!("Date")
                                Plots.savefig( "/Users/magali/Documents/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/Results/Rootzone/"*string(startyear)*"/Defreggental/"*ep_method*"_all_timeseries_normal_" *string(startyear)*"_"*string(endyear)* "_"*string(n) * ".png", )
                                ...
                                yaxis!("Sr,max [mm]")
                                Plots.savefig( "/Users/magali/Documents/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/Results/Rootzone/"*string(startyear)*"/Defreggental/"*ep_method*"_Parameters_"*string(startyear)*"_"*string(endyear)*".png")
                                #println(df)
                        end
...
function run_srdef_defreggental_obs(path_to_best_parameter, startyear, endyear, period, spinup, ploton)
        local_path = "/Users/magali/Documents/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/"
        # ------------ CATCHMENT SPECIFIC INPUTS----------------
        ID_Prec_Zones = [17700, 114926]
        # size of the area of precipitation zones
        ...
        for n = 1:1:2#size(parameters_best_calibrations)[1]
                ...
                path_to_folder = "/Users/magali/Documents/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/Results/Rootzone/Past/Defreggental/"
                ...
                if ploton=="yes"
                        ...
                        yaxis!("mm")
                        xaxis!("Year")
                        Plots.savefig( "/Users/magali/Documents/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/Results/Rootzone/Past/Defreggental/"*ep_method*"_srdef_max_year"*string(startyear)*"_"*string(endyear)*"_observed.png", )
                        ...
                        yaxis!("mm")
                        xaxis!("Date")
                        Plots.savefig( "/Users/magali/Documents/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/Results/Rootzone/Past/Defreggental/"*ep_method*"_srdef_timeseries_normal"*string(startyear)*"_"*string(endyear)*"_observed" * string(n) * ".png", )

                        Plots.plot()
                        plot!( Timeseries[startplot:endplot], srdef_timeseries[startplot:endplot], label = "Sr_def_series", )
                        yaxis!("mm")
                        xaxis!("Date")
                        Plots.savefig( "/Users/magali/Documents/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/Results/Rootzone/Past/Defreggental/"*ep_method*"_srdef_timeseries_zoom"*string(startyear)*"_"*string(endyear)*"_observed" * string(n) * ".png", )

                        Plots.plot()
                        plot!( Timeseries[index_spinup:end], srdef_continuous, label = "Sr_def", )
                        yaxis!("mm")
                        xaxis!("Date")
                        Plots.savefig( "/Users/magali/Documents/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/Results/Rootzone/Past/Defreggental/"*ep_method*"_srdef_timeseries_cum_"*string(startyear)*"_"*string(endyear)*"_observed" * string(n) * ".png", )

                        Plots.plot()
                        plot!( Timeseries[startplot:endplot], srdef_continuous[startplot+1:endplot+1], label = "Sr_def", )
                        yaxis!("mm")
                        xaxis!("Date")
                        Plots.savefig( "/Users/magali/Documents/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/Results/Rootzone/Past/Defreggental/"*ep_method*"_srdef_timeseries_cum_zoom_"*string(startyear)*"_"*string(endyear)*"_observed" * string(n) * ".png", )
                        ...
                        yaxis!("mm")
                        xaxis!("Date")
                        Plots.savefig( "/Users/magali/Documents/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/Results/Rootzone/Past/Defreggental/"*ep_method*"_all_timeseries_normal_"*string(startyear)*"_"*string(endyear)*"_observed" * string(n) * ".png", )
                        ...
                        xticks!([1:2;], ["Forest", "Grass"])
                        yaxis!("Sr,max [mm]")
                        Plots.savefig( "/Users/magali/Documents/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/Results/Rootzone/Past/Defreggental/Parameters_"*string(startyear)*"_"*string(endyear)*"_observed.png")
                end
        end
...
# run_srdef_defreggental("/Users/magali/Documents/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/Data/Projections/rcp45/CNRM-CERFACS-CNRM-CM5_rcp45_r1i1p1_CLMcom-CCLM4-8-17_v1_day/Defreggental/", "/Users/magali/Documents/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/Calibrations/Defreggental/Best/Defreggental_parameterfitless_dates_snow_redistr_best_combined_300_validation_10years.csv", 2071,2100,"future2100", 3, "no")
...
# run_srdef_defreggental_obs("/Users/magali/Documents/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/Calibrations/Defreggental/Best/Defreggental_parameterfitless_dates_snow_redistr_best_combined_300_validation_10years.csv", 1981,2010,"observed", 3, "no")

function GEV_defreggental(path_to_folder, startyear, endyear)
        startyear_og = startyear
        Grass = Float64[]
        Forest = Float64[]
        EP = ["Thorntwaite", "Hargreaves"]
        for (e,ep_method) in enumerate(EP)
                startyear=startyear_og
                data = CSV.read(path_to_folder * ep_method* "_Defreggental_sdef_max_year_"*string(startyear)*"_"*string(endyear), DataFrame, header = true, decimal = '.', delim = ',')
                ...
                xaxis!("xti")
                yaxis!("yti")
                Plots.savefig("/Users/magali/Documents/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/Results/Rootzone/"*string(startyear)*"/Defreggental/"*ep_method*"_GEVstart_defreggental_xtyt.png")
                ...
                xaxis!("T")
                yaxis!("mm")
                Plots.savefig("/Users/magali/Documents/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/Results/Rootzone/"*string(startyear)*"/Defreggental/"*ep_method*"_GEVstart_defreggental_Txt.png")
                push!(Grass, xt[1])
                push!(Forest, xt[4])
        end
        Output=DataFrame(PE_method = EP, T2=Grass, T20=Forest)
        CSV.write("/Users/magali/Documents/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/Results/Rootzone/"*string(startyear)*"/Defreggental/"*string(startyear)*"_GEV_T.csv", Output)
...
function GEVresult(path_to_best_parameter, catchment_name)
        ...
        for (e,ep_method) in enumerate(PE)
                scatter!([1],[-mod_past.T20[e]], label="mod_past_"*ep_method, color="purple",markershape=[Markers[e]], markersize=3, markerstrokewidth=0)
                scatter!([1],[-mod_future.T20[e]],label="mod_future_"*ep_method, color="darkorange", markershape=[Markers[e]], markersize=3, markerstrokewidth=0)
                scatter!([1],[-obs_past.T20[e]],label="obs_past_"*ep_method, color="royalblue", markershape=[Markers[e]], markersize=3, markerstrokewidth=0)
                scatter!([2],[-mod_past.T2[e]], label=false, color="purple",markershape=[Markers[e]], markersize=3, markerstrokewidth=0)
                scatter!([2],[-mod_future.T2[e]],label=false, color="darkorange", markershape=[Markers[e]], markersize=3, markerstrokewidth=0)
                scatter!([2],[-obs_past.T2[e]],label=false, color="royalblue", markershape=[Markers[e]], markersize=3, markerstrokewidth=0)
        end
        ...
        Plots.savefig( "/Users/magali/Documents/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/Results/Rootzone/"*catchment_name*"_Parameter_comparison.png")
        ...
        for (e,ep_method) in enumerate(PE)
                ...
                yaxis!("Sr,max [mm]", font(8))
                xaxis!([0.5,2.5])
                Plots.savefig( "/Users/magali/Documents/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/Results/Rootzone/"*catchment_name*"_"*ep_method*"_Parameter_comparison_points.png")
        ...
        for (e,ep_method) in enumerate(PE)
                ...
                yaxis!("Sr,max [mm]", font(8))
                xaxis!([0.5,2.5])
                Plots.savefig( "/Users/magali/Documents/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/Results/Rootzone/"*catchment_name*"_Parameter_comparison_points.png")
        ...
        #         for (e,ep_method) in enumerate(PE)
        #
        #                 scatter!([e],[mod_past.T20[e]], label="mod_past"*ep_method)
        #                 scatter!([e],[mod_future.T20[e]],label="mod_future"*ep_method)
        #                 scatter!([e],[obs_past.T20[e]],label="obs_past"*ep_method)
        #         end
        #         #scatter!(xt2)
        #         xticks!([1:2;], ["Forest", "Grass"])
        #         yaxis!("Sr,max [mm]")
        #         Plots.savefig( "/Users/magali/Documents/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/Results/Rootzone/Past/Defreggental/Parameter_comparison_points.png")

...
function snowperelevation_srdef(Bare::HRU_Input_srdef, Forest::HRU_Input_srdef, Grass::HRU_Input_srdef, Rip::HRU_Input_srdef, Bare_Storage::Storages, Forest_Storage::Storages, Grass_Storage::Storages, Rip_Storage::Storages, Total_Elevationbands)
...
"""
function hillslopeHRU_future_srdef(hill::HRU_Input_srdef, storages::Storages, parameters::Parameters)
    ...
    hill_out = Outflows_srdef(Fast_Discharge, GWflow, Soil_Evaporation, Total_Interception_Evaporation, Total_Effective_Precipitation)
    ...
    return hill_out::Outflows_srdef, hill_storages::Storages, Precipitation, All_Storages, Total_Melt
...
function riparianHRU_future_srdef(rip::HRU_Input_srdef, storages::Storages, parameters::Parameters)
    ...
    rip_out = Outflows_srdef(Fast_Discharge, GWflow, Soil_Evaporation, Total_Interception_Evaporation, Total_Effective_Precipitation)
...
function allHRU_future_srdef(bare_input::HRU_Input_srdef, forest_input::HRU_Input_srdef, grass_input::HRU_Input_srdef, rip_input::HRU_Input_srdef,
    ...
    #bare rock HRU
    bare_outflow::Outflows_srdef, bare_storage::Storages, Bare_precipitation::Float64, Bare_Storages::Float64, Bare_Melt::Float64 = hillslopeHRU_future_srdef(bare_input, bare_storage, bare_parameters)
    # forest HRU
    forest_outflow::Outflows_srdef, forest_storage::Storages, Forest_precipitation::Float64, Forest_Storages::Float64, Forest_Melt::Float64 = hillslopeHRU_future_srdef(forest_input, forest_storage, forest_parameters)
    # Grassland HRU
    grass_outflow::Outflows_srdef, grass_storage::Storages, Grass_precipitation::Float64, Grass_Storages::Float64, Grass_Melt::Float64, = hillslopeHRU_future_srdef(grass_input, grass_storage, grass_parameters)
    # riparian HRU
    rip_outflow::Outflows_srdef, rip_storage::Storages, Rip_precipitation::Float64, Rip_Storages::Float64, Rip_Melt::Float64 = riparianHRU_future_srdef(rip_input, rip_storage, rip_parameters)
    ...
    Effective_Prec::Float64 = bare_outflow.Effective_Precipitation  + forest_outflow.Effective_Precipitation + grass_outflow.Effective_Precipitation + rip_outflow.Effective_Precipitation
    ...
    #Effective_Prec = Bare_Pe * bare_input.Area_HRU+ Forest_Pe * bare_input.Area_HRU+ Grass_Pe * bare_input.Area_HRU+ Rip_Pe * bare_input.Area_HRU
...
function input_timestep_srdef(Input::HRU_Input_srdef, Evaporation_Mean::Float64, Precipitation::Array{Float64,1}, Temperature::Array{Float64,1})
    ...
    return Input::HRU_Input_srdef
end

function input_timestep_srdef_glacier(Input::HRU_Input_srdef, Evaporation_Mean::Float64, Glacier_Area::Array{Float64,1}, Precipitation::Array{Float64,1}, Temperature::Array{Float64,1})
    #Input.Potential_Evaporation::Array{Float64,1} = Evaporation
    Input.Potential_Evaporation_Mean::Float64 = Evaporation_Mean
    # get the precipitation data of the necessary elevations
    Precipitation_HRU = Float64[]
...
function run_model_future_srdef(Area, Evaporation_Mean::Array{Float64,1}, Precipitation::Array{Float64,2}, Temp::Array{Float64,2},
    ...
    for t in 1:tmax
        ...
        #Effective_Precipitation_Current = Effective_Precipitation[t,:]
        Temperature_Current = Temp[t, :]

        bare_input::HRU_Input_srdef = input_timestep_srdef(bare_input, Evaporation_Mean_Current, Precipitation_Current, Temperature_Current)
        ...
        Snow_Elevations, Snow_Extend[t,:]::Array{Float64,1} = snowperelevation_srdef(bare_input, forest_input, grass_input, rip_input, bare_storage, forest_storage, grass_storage, rip_storage, Total_Elevationbands)
        #Bare_Snow[t,:]::Array{Float64,1} = bare_storage.Snow
        Snow_Extend[t,:] = Snow_Extend[t,:] ./ Elevation_Percentage
        Total_Melt[t] = Melt


        Bare_Interceptionstorage::Float64, Bare_Snowstorage::Float64 = Storage_Total_srdef(bare_storage, bare_input)
        Forest_Interceptionstorage::Float64, Forest_Snowstorage::Float64 = Storage_Total_srdef(forest_storage, forest_input)
        Grass_Interceptionstorage::Float64, Grass_Snowstorage::Float64 = Storage_Total_srdef(grass_storage, grass_input)
        Rip_Interceptionstorage::Float64, Rip_Snowstorage::Float64 = Storage_Total_srdef(rip_storage, rip_input)

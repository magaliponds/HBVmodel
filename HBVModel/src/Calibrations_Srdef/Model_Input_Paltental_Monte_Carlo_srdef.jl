...
function run_MC_time_ep(nmax)
        ...
        PEmethod = ["TW", "HG"]
        Timeframes = ["OP", "MP", "MF"]
        parameter_range = CSV.read("/Users/magali/Documents/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/Results/Rootzone/Srdef_ranges/rcp45/CNRM-CERFACS-CNRM-CM5_rcp45_r1i1p1_CLMcom-CCLM4-8-17_v1_day/Paltental_srdef_range.csv", DataFrame, decimal = '.', delim = ',' )

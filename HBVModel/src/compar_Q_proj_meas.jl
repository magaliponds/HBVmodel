...
monthly_discharge_measured = readdlm("/Users/magali/Documents/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/Results/Projections/"*Catchment_Name*"/Comparison_Real_Proj/Discharge/Discharge_obs_85_13.csv", ',')
# rows= timeseries, columns = number runs
monthly_discharge_modelled_measured_data = readdlm("/Users/magali/Documents/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/Results/Projections/"*Catchment_Name*"/Comparison_Real_Proj/Discharge/Discharge_mod__measured_data_85_13.csv")
...
function plot_monthly_discharge_meas_proj(Monthly_Discharge_past_meas, Monthly_Discharge_past_45, Monthly_Discharge_past_85, average_Monthly_Discharge_past_meas, months_meas, months_45, Catchment_Name,Area_Catchment, nr_runs, mod_meas, violin_box)
    ...
    # savefig("/Users/magali/Documents/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/Results/Projections/"*Catchment_Name*"/Comparison_Real_Proj/Discharge/"*Catchment_Name*"_monthly_discharge_"*mod_meas*"_proj45.png")
    #
    # # for RCP 8.5
    # plot()
    # Farben_85 = palette(:reds)
    ...
    # xticks!([1.5:2:23.5;], ["Jan", "Feb", "Mar", "Apr", "May","Jun", "Jul", "Aug", "Sep", "Oct", "Nov", "Dec"])
    # #xticks!([2:2:24;], ["Jan 8.5", "Feb 8.5", "Mar 8.5", "Apr 8.5", "May 8.5","Jun 8.5", "Jul 8.5", "Aug 8.5", "Sep 8.5", "Oct 8.5", "Nov 8.5", "Dec 8.5"])
    # savefig("/Users/magali/Documents/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/Results/Projections/"*Catchment_Name*"/Comparison_Real_Proj/Discharge/"*Catchment_Name*"_monthly_discharge_"*mod_meas*"_proj85.png")
    ...
    xticks!([1.5:2:23.5;], ["Jan", "Feb", "Mar", "Apr", "May","Jun", "Jul", "Aug", "Sep", "Oct", "Nov", "Dec"])
    #xticks!([2:2:24;], ["Jan 8.5", "Feb 8.5", "Mar 8.5", "Apr 8.5", "May 8.5","Jun 8.5", "Jul 8.5", "Aug 8.5", "Sep 8.5", "Oct 8.5", "Nov 8.5", "Dec 8.5"])
    savefig("/Users/magali/Documents/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/Results/Projections/"*Catchment_Name*"/Comparison_Real_Proj/Discharge/"*Catchment_Name*"_monthly_discharge_"*mod_meas*"_proj45_mm_"*violin_box*".png")
    ...
    xticks!([1.5:2:23.5;], ["Jan", "Feb", "Mar", "Apr", "May","Jun", "Jul", "Aug", "Sep", "Oct", "Nov", "Dec"])
    #xticks!([2:2:24;], ["Jan 8.5", "Feb 8.5", "Mar 8.5", "Apr 8.5", "May 8.5","Jun 8.5", "Jul 8.5", "Aug 8.5", "Sep 8.5", "Oct 8.5", "Nov 8.5", "Dec 8.5"])
    savefig("/Users/magali/Documents/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/Results/Projections/"*Catchment_Name*"/Comparison_Real_Proj/Discharge/"*Catchment_Name*"_monthly_discharge_"*mod_meas*"_proj85_mm_"*violin_box*"_tets.png")
end
...
function plot_monthly_discharge_meas_proj_violin(Monthly_Discharge_past_meas, Monthly_Discharge_past_45, Monthly_Discharge_past_85, months_meas, months_45, Catchment_Name,Area_Catchment, nr_runs, mod_meas)
    ...
    xticks!([1.5:2:23.5;], ["Jan", "Feb", "Mar", "Apr", "May","Jun", "Jul", "Aug", "Sep", "Oct", "Nov", "Dec"])
    #xticks!([2:2:24;], ["Jan 8.5", "Feb 8.5", "Mar 8.5", "Apr 8.5", "May 8.5","Jun 8.5", "Jul 8.5", "Aug 8.5", "Sep 8.5", "Oct 8.5", "Nov 8.5", "Dec 8.5"])
    savefig("/Users/magali/Documents/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/Results/Projections/"*Catchment_Name*"/Comparison_Real_Proj/Discharge/"*Catchment_Name*"_monthly_discharge_"*mod_meas*"_proj45_violin.png")
    ...
    xticks!([1.5:2:23.5;], ["Jan", "Feb", "Mar", "Apr", "May","Jun", "Jul", "Aug", "Sep", "Oct", "Nov", "Dec"])
    #xticks!([2:2:24;], ["Jan 8.5", "Feb 8.5", "Mar 8.5", "Apr 8.5", "May 8.5","Jun 8.5", "Jul 8.5", "Aug 8.5", "Sep 8.5", "Oct 8.5", "Nov 8.5", "Dec 8.5"])
    savefig("/Users/magali/Documents/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/Results/Projections/"*Catchment_Name*"/Comparison_Real_Proj/Discharge/"*Catchment_Name*"_monthly_discharge_"*mod_meas*"_proj85_violin.png")
    ...
    xticks!([1.5:2:23.5;], ["Jan", "Feb", "Mar", "Apr", "May","Jun", "Jul", "Aug", "Sep", "Oct", "Nov", "Dec"])
    #xticks!([2:2:24;], ["Jan 8.5", "Feb 8.5", "Mar 8.5", "Apr 8.5", "May 8.5","Jun 8.5", "Jul 8.5", "Aug 8.5", "Sep 8.5", "Oct 8.5", "Nov 8.5", "Dec 8.5"])
    savefig("/Users/magali/Documents/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/Results/Projections/"*Catchment_Name*"/Comparison_Real_Proj/Discharge/"*Catchment_Name*"_monthly_discharge_"*mod_meas*"_proj45_mm_violin.png")
    ...
    xticks!([1.5:2:23.5;], ["Jan", "Feb", "Mar", "Apr", "May","Jun", "Jul", "Aug", "Sep", "Oct", "Nov", "Dec"])
    #xticks!([2:2:24;], ["Jan 8.5", "Feb 8.5", "Mar 8.5", "Apr 8.5", "May 8.5","Jun 8.5", "Jul 8.5", "Aug 8.5", "Sep 8.5", "Oct 8.5", "Nov 8.5", "Dec 8.5"])
    savefig("/Users/magali/Documents/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/Results/Projections/"*Catchment_Name*"/Comparison_Real_Proj/Discharge/"*Catchment_Name*"_monthly_discharge_"*mod_meas*"_proj85_mm_violin.png")
end
...
function plot_ecdf_monthly_discharge(average_Monthly_Discharge_past_meas, Monthly_Discharge_past, Catchment_Name, nr_runs, rcp)
    ...
    for proj in 1:14
        ...
        # savefig("/Users/magali/Documents/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/Results/Projections/"*Catchment_Name*"/Comparison_Real_Proj/Discharge/ECDF_timing_AMF_proj_"*string(proj)*"_"*rcp*".png")
    end
    plot!(StatsBase.ecdf(average_Monthly_Discharge_past_meas), label="measured", color="red", size=(1000,800), dpi=300, linewidth=4)
    savefig("/Users/magali/Documents/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/Results/Projections/"*Catchment_Name*"/Comparison_Real_Proj/Discharge/ECDF_monthly_discharge_allprojections_"*rcp*"_mm.png")
end
...
# xlims!((1,365))
# savefig("/Users/magali/Documents/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/Results/Projections/"*Catchment_Name*"/Comparison_Real_Proj/Discharge/ECDF_timing_AMF_proj_allprojections_together_"*"45"*".png")
# plot()
...
# savefig("/Users/magali/Documents/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/Results/Projections/"*Catchment_Name*"/Comparison_Real_Proj/Discharge/ECDF_magnitude_AMF_proj_allprojections_together_"*"45"*".png")
...
function plot_cdf_AMF_timing_meas_proj_mean_median(Date_Past_mean, Date_Past_median, Date_measured, Catchment_Name, nr_runs, rcp)
    ...
    plot!(StatsBase.ecdf(Date_measured), label="measured", color="red", size=(1000,800), dpi=300, linewidth=4)
    xlims!((1,365))
    savefig("/Users/magali/Documents/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/Results/Projections/"*Catchment_Name*"/Comparison_Real_Proj/Discharge/ECDF_timing_AMF_proj_allprojections_mean_"*rcp*".png")
end
...
function plot_cdf_AMF_timing_meas_proj(Date_Past, Date_measured, Catchment_Name, nr_runs, rcp)
    ...
    plot!(StatsBase.ecdf(Date_measured), label="measured", color="red", size=(1000,800), dpi=300, linewidth=4)
    savefig("/Users/magali/Documents/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/Results/Projections/"*Catchment_Name*"/Comparison_Real_Proj/Discharge/ECDF_timing_AMF_proj_allprojections_"*rcp*".png")
end
...
function plot_cdf_AMF_magnitude_meas_proj(Magnitude_Past, Magnitude_measured, Catchment_Name, nr_runs, rcp)
    ...
    for proj in 1:14
        ...
        # savefig("/Users/magali/Documents/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/Results/Projections/"*Catchment_Name*"/Comparison_Real_Proj/Discharge/ECDF_magnitude_AMF_proj_"*string(proj)*"_"*rcp*".png")
    end
    plot!(StatsBase.ecdf(Magnitude_measured), label="measured", color="red", size=(1000,800), dpi=300, linewidth=4)
    savefig("/Users/magali/Documents/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/Results/Projections/"*Catchment_Name*"/Comparison_Real_Proj/Discharge/ECDF_magnitude_AMF_proj_allprojections_"*rcp*".png")
end
...
function plot_cdf_AMF_magnitude_meas_mod(Magnitude_Past, Magnitude_measured, Catchment_Name, nr_runs)
    ...
    for i in 1:nr_runs
        ...
        # savefig("/Users/magali/Documents/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/Results/Projections/"*Catchment_Name*"/Comparison_Real_Proj/Discharge/ECDF_magnitude_AMF_proj_"*string(proj)*"_"*rcp*".png")
    plot!(StatsBase.ecdf(Magnitude_measured), label="measured", color="red", size=(1000,800), dpi=300, linewidth=4)
    savefig("/Users/magali/Documents/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/Results/Projections/"*Catchment_Name*"/Comparison_Real_Proj/Discharge/ECDF_magnitude_AMF_mod_real_data.png")
end
...
# min_discharge_prob_45 = readdlm("/Users/magali/Documents/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/Results/Projections/"*Catchment_Name*"/PastvsFuture/LowFlows/low_flows_prob_distr_4.5.txt", ',')
# Farben45 = palette(:blues)
# min_discharge_prob_85 = readdlm("/Users/magali/Documents/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/Results/Projections/"*Catchment_Name*"/PastvsFuture/LowFlows/low_flows_prob_distr_8.5.txt", ',')
...
# xlims!((1,365))
# savefig("/Users/magali/Documents/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/Results/Projections/"*Catchment_Name*"/Comparison_Real_Proj/Discharge/Low_Flows/ECDF_timing_allprojections_together_"*"45"*".png")
# plot()
# plot!(StatsBase.ecdf(convertDischarge(max_Discharge_Past_45, Area_Catchment)), label="Projections", color="black", size=(1000,800), dpi=300, linewidth=3)
...
# savefig("/Users/magali/Documents/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/Results/Projections/"*Catchment_Name*"/Comparison_Real_Proj/Discharge/Low_Flows/ECDF_magnitude_allprojections_together_"*"45"*".png")
...
function plot_cdf_minimum_flows_timing_meas_proj(Date_Past, Date_measured, Catchment_Name, nr_runs, rcp)
    ...
    plot!(StatsBase.ecdf(Date_measured), label="measured", color="red", size=(1000,800), dpi=300, linewidth=4)
    savefig("/Users/magali/Documents/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/Results/Projections/"*Catchment_Name*"/Comparison_Real_Proj/Discharge/Low_Flows/ECDF_timing_minimum_flows_proj_allprojections_"*rcp*".png")
end
...
function plot_cdf_minmum_flows_magnitude_meas_proj(Magnitude_Past, Magnitude_measured, Catchment_Name, nr_runs, rcp)
    ...
    for proj in 1:14
        ...
        # plot!(StatsBase.ecdf(Magnitude_measured), label="measured", color="red", size=(1000,800), dpi=300, linewidth=4)
        # savefig("/Users/magali/Documents/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/Results/Projections/"*Catchment_Name*"/Comparison_Real_Proj/Discharge/Low_Flows/ECDF_magnitude_min_flows_proj_"*string(proj)*"_"*rcp*".png")
    end
    plot!(StatsBase.ecdf(Magnitude_measured), label="measured", color="red", size=(1000,800), dpi=300, linewidth=4)
    savefig("/Users/magali/Documents/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/Results/Projections/"*Catchment_Name*"/Comparison_Real_Proj/Discharge/Low_Flows/ECDF_magnitude_min_flows_proj_allprojections_"*rcp*".png")
end
...
function plot_all_timing_magnitude(All_Projections_Precipitation, Precipitation_Observed, Timeseries_Prec, Date_AMF, Date_AMF_meas, Date_min, Date_min_meas, Mag_AMF, Mag_AMF_meas, Mag_min, Mag_min_meas, Catchment_Name, Area_Catchment)
    ...
    savefig("/Users/magali/Documents/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/Results/Projections/"*Catchment_Name*"/Comparison_Real_Proj/Discharge/ECDF_all_new.png")
end
...
function plot_all_monthly_prec_temp_runoff(All_Projections_Temp, Temperature_Observed, All_Projections_Prec, Precipitation_Observed, average_Monthly_Discharge_past_meas, Monthly_Discharge_past_meas, Monthly_Discharge_past_45, Timeseries, Timeseries_Temp)
    ...
    savefig("/Users/magali/Documents/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/Results/Projections/"*Catchment_Name*"/Comparison_Real_Proj/Discharge/monthly_boxplots_all_new_correct.png")
end
